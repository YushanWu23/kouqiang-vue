    ...
    <div class="wrapper">
        <div class="login-container">
            ...
            <div class="emailNum">
                ...
                <div class="Text2">
                    <input type="text" v-model="admin.adminId" placeholder="邮&nbsp;箱&nbsp;号">
                </div>
            </div>
            <div class="emailCode">
                <div class="Text1">
            ...
            <div class="pwd">
                ...
                <div class="Text2">
                    <input type="password" v-model="admin.password" placeholder="新&nbsp;密&nbsp;码">
                </div>
            </div>
            <div class="rePwd">
                <div class="Text1">
...
function passwordSave() {
    ...
    if (admin.value.password !== rePassword.value) {
        alert("新密码和确认密码不匹配！");
        return;
    }
    axiosInstance.post('/admin/passwordForget',{
        adminId : admin.value.adminId,
        newPassword: admin.value.password,
...
function sendEmailCode(){
    ...
    axiosInstance.post('/admin/sendForgetPasswordEmailCode', {
        adminId: admin.value.adminId
    },{
        headers : {
            "Content-Type" : "application/x-www-form-urlencoded"
