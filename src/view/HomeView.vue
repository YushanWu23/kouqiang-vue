...
function fetchBusinesses(){
    axiosInstance.get('/business/getAll')
        .then(response => {
...
.wrapper .bodyPart1 .productType{
    display: flex;
    align-items: center;
}
.wrapper .bodyPart1 .productType li {
    height: 18vw;
    width: 20vw;
 }
.wrapper .bodyPart1 .productType li img{
    align-items: center;
    display: flex;
    justify-content: center;
    height: 11vw;
...
.wrapper .bodyPart1 .productType li .typeText{
    font-size: 3.5vw;
    align-items: center;
    display: flex;
    justify-content: center;
